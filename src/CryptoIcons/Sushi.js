...
const SvgSushi = ({ title, titleId, ...props }) => (
  <svg
    viewBox="0 0 32 32"
  ...
  >
    ...
    <defs>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="sushi_svg__c">
      ...
      <circle id="sushi_svg__b" cx={16} cy={15} r={15} />
    </defs>
    <g fill="none" fillRule="evenodd">
      <use fill="#000" filter="url(#sushi_svg__a)" xlinkHref="#sushi_svg__b" />
      <use fill="#D65892" xlinkHref="#sushi_svg__b" />
      <use
