...
const SvgPaxg = ({ title, titleId, ...props }) => (
  <svg
    viewBox="0 0 32 32"
  ...
  >
    ...
    <defs>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="paxg_svg__c">
      ...
      <circle id="paxg_svg__b" cx={16} cy={15} r={15} />
    </defs>
    <g fill="none" fillRule="evenodd">
      <use fill="#000" filter="url(#paxg_svg__a)" xlinkHref="#paxg_svg__b" />
      <use fill="#E4CE4D" xlinkHref="#paxg_svg__b" />
      <use
        fill="url(#paxg_svg__c)"
        style={{
          mixBlendMode: "soft-light",
        }}
        xlinkHref="#paxg_svg__b"
      />
      <circle
        strokeOpacity={0.097}
        stroke="#000"
