...
const SvgNuls = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <defs>
      ...
      <path
        id="nuls_svg__e"
        d="M14.403 18.36 16 20.464V25l-6-2.663V10.619c0-.173.077-.338.212-.453l.683-.585a.636.636 0 0 1 .923.097l5.465 7.164 3.019 1.846v-9.88l-2.668-1.331-.13 6.196-1.412-1.873-.064-6.8L22 7.779v11.664l-1.357 1.118-4.274-2.387-4.744-6.223-.065 9.454 2.825 1.447.018-4.492z"
      />
    </defs>
