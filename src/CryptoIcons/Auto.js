...
const SvgAuto = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <defs>
      ...
      <path
        id="auto_svg__e"
        d="m24.5 18.267-4.185-2.511.48-1.989 1.787 1.055V11.19l-5.74-3.422v7.9l-1.365.755 7.538 4.47L16 25l-8.5-4.978v-9.955L16 5l8.5 5.067v8.2zM9.418 11.19v6.478l5.518-3.2V7.9l-5.518 3.289zm4.097 6.344-3.138 1.919L16 22.745l3.175-1.86-5.66-3.352z"
      />
    </defs>
