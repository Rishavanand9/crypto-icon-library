...
const SvgFldc = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use
        fill="url(#fldc_svg__c)"
        style={{
          mixBlendMode: "soft-light",
        }}
        xlinkHref="#fldc_svg__b"
      />
