...
const SvgBnt = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <defs>
      ...
      <path
        id="bnt_svg__e"
        d="m15.92 4.88-4.518 2.647 4.518 2.648 4.603-2.648L15.92 4.88zm.743 14.134v5.295l6.137-3.501v-5.296l-6.137 3.502zm4.603-9.822v5.296l-4.604 2.648V11.84l4.604-2.648zm-11.082 5.296 4.604 2.648V11.84l-4.604-2.648v5.296zm0 7.174 4.604 2.647v-5.295l-4.604-2.647v5.294z"
      />
    </defs>
    <g fill="none">
