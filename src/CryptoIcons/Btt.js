...
const SvgBtt = ({ title, titleId, ...props }) => (
  <svg
    viewBox="0 0 32 32"
  ...
  >
    ...
    <defs>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="btt_svg__c">
      ...
      <circle id="btt_svg__b" cx={15} cy={15} r={15} />
    </defs>
    <g fill="none">
      <g transform="translate(1)">
        <use fill="#000" filter="url(#btt_svg__a)" xlinkHref="#btt_svg__b" />
        <use fill="#000" xlinkHref="#btt_svg__b" />
        <use
          fill="url(#btt_svg__c)"
          style={{
            mixBlendMode: "soft-light",
          }}
          xlinkHref="#btt_svg__b"
        />
        <circle
          strokeOpacity={0.097}
          stroke="#000"
