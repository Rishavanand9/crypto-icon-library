...
const SvgZest = ({ title, titleId, ...props }) => (
  <svg
    viewBox="0 0 32 32"
  ...
  >
    ...
    <defs>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="zest_svg__c">
      ...
      <circle id="zest_svg__b" cx={15} cy={15} r={15} />
    </defs>
    <g fill="none" fillRule="evenodd">
      <g transform="translate(1)" fillRule="nonzero">
        <use fill="#000" filter="url(#zest_svg__a)" xlinkHref="#zest_svg__b" />
        <use fill="#07BC9C" xlinkHref="#zest_svg__b" />
        <use
          fill="url(#zest_svg__c)"
          style={{
            mixBlendMode: "soft-light",
          }}
          xlinkHref="#zest_svg__b"
        />
        <circle
          strokeOpacity={0.097}
          stroke="#000"
