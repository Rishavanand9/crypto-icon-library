...
const SvgTkn = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <defs>
      ...
      <path
        id="tkn_svg__e"
        d="M13.092 6.913 17.495 5l-.036 5.053H23v3.5h-5.578v6.063c0 1.84 3.12 2.057 4.294 1.444l1.064 3.176c-2.606 1.515-9.725 1.154-9.725-4.584V6.912h.037zm-4.11 7.578C7.887 14.491 7 13.425 7 12.11c0-1.316.887-2.382 1.982-2.382 1.094 0 1.981 1.066 1.981 2.382 0 1.315-.887 2.381-1.981 2.381z"
      />
    </defs>
    <g fill="none">
