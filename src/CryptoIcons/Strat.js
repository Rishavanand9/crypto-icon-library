...
const SvgStrat = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g fillRule="nonzero">
        <use
          fill="#000"
          filter="url(#strat_svg__d)"
          xlinkHref="#strat_svg__e"
        />
