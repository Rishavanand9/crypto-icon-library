...
const Svg0Xbtc = ({ title, titleId, ...props }) => (
  <svg
    viewBox="0 0 32 32"
  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g fill="#FFF">
        ...
        <path
          d="M14.09 23.132c.248-.102 1.218-.85 2.155-1.655a51.685 51.685 0 0 0 3.348-3.113c1.026-1.026 1.407-1.467 1.47-1.695.222-.801-2.205-9.606-2.699-9.795-.301-.116-2.993 2.123-5.377 4.467-1.398 1.374-1.785 1.831-1.815 2.13-.02.231.06.81.209 1.496.593 2.722 1.672 6.483 2.218 7.718.229.524.255.547.49.447z"
          fillRule="nonzero"
        />
      </g>
    </g>
