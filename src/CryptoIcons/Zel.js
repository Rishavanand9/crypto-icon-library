...
const SvgZel = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <defs>
      ...
      <path
        id="zel_svg__e"
        d="m5 14.615 4.495-2.538 4.494 2.538v4.847L9.495 22 5 19.462v-4.847zm13.01 0 4.495-2.538L27 14.615v4.847L22.505 22l-4.494-2.538v-4.847zm-.472 4.21-1.577.867-1.499-.823V14.23l-4.1-2.316V10.23L15.961 7l5.598 3.23v1.73l-4.021 2.27v4.596z"
      />
    </defs>
