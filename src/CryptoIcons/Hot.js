...
const SvgHot = ({ title, titleId, ...props }) => (
  <svg
    viewBox="0 0 32 32"
  ...
  >
    ...
    <defs>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="hot_svg__c">
      ...
      <circle id="hot_svg__b" cx={15} cy={15} r={15} />
    </defs>
    <g fill="none">
      <g transform="translate(1)">
        <use fill="#000" filter="url(#hot_svg__a)" xlinkHref="#hot_svg__b" />
        <use fill="#8834FF" xlinkHref="#hot_svg__b" />
        <use
          fill="url(#hot_svg__c)"
          style={{
