...
const SvgTnt = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <defs>
      ...
      <path
        id="tnt_svg__e"
        d="M13.89 20.503 14.048 24s1.875-.318 3.828 0l.156-3.497h-4.14zM11.626 17.8s5.469-.477 8.672 0l.312-3.815a59.109 59.109 0 0 0-9.14 0l.156 3.815zM26 7.944S15.531 5.718 6 8.103l.703 4.371.86-1.669s8.984-1.351 17.03 0l.782 1.67L26 7.943z"
      />
    </defs>
    <g fill="none">
