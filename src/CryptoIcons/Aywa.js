...
const SvgAywa = ({ title, titleId, ...props }) => (
  <svg
    viewBox="0 0 32 32"
  ...
  >
    ...
    <defs>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="aywa_svg__c">
      ...
      <circle id="aywa_svg__b" cx={15} cy={15} r={15} />
    </defs>
    <g fill="none" fillRule="evenodd">
      <g transform="translate(1)" fillRule="nonzero">
        <use fill="#000" filter="url(#aywa_svg__a)" xlinkHref="#aywa_svg__b" />
        <use fill="#3355B5" xlinkHref="#aywa_svg__b" />
        <use
